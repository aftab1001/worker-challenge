...
export class AppConfiguration {
    ...
    public static WorkerStartingPort = process.env.WorkerStartingPort
        ? parseInt(process.env.WorkerStartingPort, 10)
        : 3000;
    ...
    public static MaxSampleCollection = process.env.MaxSampleCollection
        ? parseInt(process.env.MaxSampleCollection)
        : 150;
}
